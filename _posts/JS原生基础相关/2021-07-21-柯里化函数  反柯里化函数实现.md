...
- 反柯里化：将一个方法从“属于某个对象”转换为 **通用的函数**，使得这个方法可以被其他对象借用

```js
Function.prototype.uncurrying = function () {
    var self = this; // 要转化的原型上的函数/调用函数
    return function() {
        // 常见写法
        var obj = Array.prototype.shift.call(arguments); // 调用时的第一个参数
        return self.apply(obj, arguments);
        // 另一种写法
        return Function.prototype.call.apply(self, arguments);
        // 将 self 作为 Function.prototype.call 的 this 的值，arguments 是参数 - 相当于 self.call(arguments[0], arguments[1], ...)
    }
}
```
