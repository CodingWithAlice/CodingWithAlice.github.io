...
@Module({
    controllers: [CatsController], // 创建控制器【必须创建】
    providers: [CatsService],      // 由 Nest 注入控制器实例化的 Provider
...
##### ①模块配置 - NestModule/configure + MiddlewareConsumer
