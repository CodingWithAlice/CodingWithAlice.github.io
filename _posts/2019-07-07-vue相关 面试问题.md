...
5. 挂载的时候，子组件完成挂载后，父组件才会挂载；
   ...
   注意：在传值的时候，如果父组件在mounted传给子组件值，子组件是没有办法在created里面使用的![image-20200313140536045](/img/assets_2019/image-20200313140536045.png)![图片描述](/img/assets_2019/156466691112.png)
