...
### 12.数组常用的遍历方法有哪几种？（for...in一般用于对象）

### 13. Canvas绘图；

### 14.Webpack；

### 15.Ajax遇到拦截器，请求数据要重新处理怎么做？
...
6. 可以通过什么途径查看一个网站所使用的技术

7. react的核心是什么

8. vue router有哪些钩子函数，介绍，哪一个是可以在全局使用的




1. 为什选择`vue+element`这样一个体系搭建系统？有什么吗优点？
...
3.在这半年多的学习过程中，觉得前端学习的难点在哪里：封装的太好，原生其实很难
