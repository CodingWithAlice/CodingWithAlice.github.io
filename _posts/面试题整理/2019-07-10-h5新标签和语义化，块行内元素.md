...
- 新增了许多input **type属性**：<u>`email`、`tel`、『`url`</u>』、`number`、『<u>`search`搜索框，加强语义、`range`自由拖动滑块</u>』、`time`、`date`日期、`datetime`时间、`month`、`week`
...
- 行内元素：span、**a**、u、i、b、strong、『<u>em、select、label、textarea、button、**br**</u>』

-	块级元素：div、ol、ul、li、table、th、**p**、『<u>tr、dd、dt、dl、caption、address、h1～h6</u>』、hr
