...
### 二、复盘工具 [Next_Pro](https://github.com/CodingWithAlice/Next_Pro)   changeLog
...
1、需求8计划：提供运动记录、管理的界面呈现方式，方便打卡和管理 ✅
...
1、提供筛选最小日期功能，便于按计划做题 ✅

2、mongodb 由于磁盘占满数据覆盖，导致历史数据全部丢失 😭



##### ## 2025.06.26

1、线轴信息不采用手工录入，改为数据库数据管理

2、校验做题答案时，接入 Deepseek 便于排查、修正 ✅



##### ## 2025.05.05

1、添加 隔天重做入口，利用记忆曲线加强知识点的记忆 ✅

2、添加 当日做题记录查询入口，方便复盘
