...
### 5.定义在`utils`里面的静态的`storage.js`文件中的方法
...
### 11.`this.$message.success("签到成功"); `弹出签到成功



### 12.报错`TypeError: Object(...) is not a function`
...
新增接口类别后，一定一定要记得去`vue.config.js`里面添加`context `
